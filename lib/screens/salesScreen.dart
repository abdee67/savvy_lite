...
import 'package:savvy_stock/screens/SalesOrder.dart';
import 'package:savvy_stock/screens/customerEntryScreen.dart';
  ...
  void _handleAction(String action) {
    switch (action) {
      case "Sales Entry":
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const SalesOrderScreen()),
        );
        break;
      ...
      case "Customer Entry":
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const CustomerEntryScreen()),
        );
        break;

...
class SalesItemEntryConfirmedItem extends StatefulWidget {
  ...
  const SalesItemEntryConfirmedItem({super.key, required this.state});
        ...
        children: [
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    child: widget.state.confirmedItems.isEmpty
                        ? _buildEmptyState()
                        : ListView.builder(
                            itemCount: widget.state.confirmedItems.length,
                            itemBuilder: (context, index) {
                              final item = widget.state.confirmedItems[index];
                  ...
                  Align(
                    ...
                    child: ElevatedButton(
                      onPressed: widget.state.totalAmount > 0
          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              height: 40,
              child: ElevatedButton(
                onPressed: widget.state.hasValidItems
                    ? () => _confirmOrder(context)
                    : null,
                style: ElevatedButton.styleFrom(
                  backgroundColor: widget.state.hasValidItems
                      ? const Color.fromARGB(255, 29, 110, 168)
                      : Colors.grey,
                  foregroundColor: widget.state.hasValidItems
                      ? Colors.white
                      : Colors.black,
                ...
                child: Text(
                  widget.state.hasValidItems ? 'Confirm Order' : 'Select item',
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                  ),
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => PaymentScreen(
          confirmedItems: widget.state.confirmedItems,

// features/reports/purchase_report/dashboard/purchase_report_dashboard.dart
import 'package:flutter/material.dart';
import 'package:iconsax_flutter/iconsax_flutter.dart';
import 'package:intl/intl.dart';
import 'package:savvy_stock/features/reports/purchase_report/dashboard/widgets/recent_transactions_table.dart';
import 'package:savvy_stock/features/reports/purchase_report/dashboard/widgets/sidebar_menu.dart';
import 'package:savvy_stock/features/reports/purchase_report/dashboard/widgets/stock_charts.dart';
import 'package:savvy_stock/features/reports/purchase_report/dashboard/widgets/summary_metrics_card.dart';

class PurchaseReportDashboard extends StatefulWidget {
  const PurchaseReportDashboard({super.key});

  @override
  State<PurchaseReportDashboard> createState() =>
      _PurchaseReportDashboardState();
}
...
class _PurchaseReportDashboardState extends State<PurchaseReportDashboard> {
          ...
          SliverAppBar(
            ...
            title: Column(
              ...
              children: [
                ...
                Text(
                  'Real-time purchase insights and analytics',
                  style: Theme.of(
                    context,
  ...
  Widget _buildChartsSection() {
    if (isMobile) {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: RecentTransactionsTable(
              ...
              transactions: _generateRecentPurchase(),
              isPurchase: true,
              tableHeight: 350,
            ),
          ),
      ...
      return Column(
        children: [
          // First Row: Average Time to Sell + Recent Purchase
          Container(
  ...
  Widget _buildRecentTransactionsSection() {
    final insightCards = [
      ...
      },
      {
        ...
        'description': 'Top 5 items by purchase velocity',
  ...
  List<TransactionData> _generateRecentPurchase() {
    return [
      TransactionData(
        item: 'Laptop Pro M3',

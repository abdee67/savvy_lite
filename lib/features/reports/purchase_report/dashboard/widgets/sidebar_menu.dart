...
class _SidebarMenuState extends State<SidebarMenu> {
  ...
  final List<SidebarMenuItem> _menuItems = [
    ...
    SidebarMenuItem(
      ...
      parentId: 'reports',
      route: AppRoutes.purchaseTransactionReport,
    ),
    SidebarMenuItem(
      id: 'goods_received_note',
      title: 'Goods Received Note',
      icon: Iconsax.calendar_tick,
      parentId: 'reports',
      route: AppRoutes.goodsReceivedNote,
    ),
    SidebarMenuItem(
      id: 'pending_purchase_report',
      title: 'Pending Purchase Report',
      icon: Iconsax.calendar_tick,
      parentId: 'reports',
      route: AppRoutes.pendingPurcahseReport,
    ),
    SidebarMenuItem(
      id: 'aged_credit_payment',
      title: 'Aged Credit Payment Report',
      icon: Iconsax.calendar_1,
      parentId: 'reports',
      route: AppRoutes.agedCreditPaymentReceiptReport,
    ),
    SidebarMenuItem(
      id: 'credit_payment',
      ...
      icon: Iconsax.calendar_1,
      parentId: 'reports',
      route: AppRoutes.creditPaymentReport,
    ),
  ];

// features/reports/cash_flow/dashboard/widgets/sidebar_menu.dart
...
class _SidebarMenuState extends State<SidebarMenu> {
  ...
  final List<SidebarMenuItem> _menuItems = [
    ...
    SidebarMenuItem(
      ...
      parentId: 'reports',
      route: AppRoutes.cashFlowSummaryReport,
    ),
    SidebarMenuItem(
      id: 'cash_inflow_report',
      title: 'Cash Inflow Report',
      icon: Iconsax.calendar_tick,
      parentId: 'reports',
      route: AppRoutes.cashInFlowReport,
    ),
    SidebarMenuItem(
      id: 'cash_outflow_report',
      title: 'Cash Outflow Report',
      icon: Iconsax.calendar_tick,
      parentId: 'reports',
      route: AppRoutes.cashOutFlowReport,
    ),
  ];

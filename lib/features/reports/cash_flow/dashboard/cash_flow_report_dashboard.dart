// features/reports/cashFlow_report/dashboard/cashFlow_report_dashboard.dart
import 'package:flutter/material.dart';
import 'package:iconsax_flutter/iconsax_flutter.dart';
import 'package:intl/intl.dart';
import 'package:savvy_stock/features/reports/cash_flow/dashboard/widgets/recent_transactions_table.dart';
import 'package:savvy_stock/features/reports/cash_flow/dashboard/widgets/sidebar_menu.dart';
import 'package:savvy_stock/features/reports/cash_flow/dashboard/widgets/stock_charts.dart';
import 'package:savvy_stock/features/reports/cash_flow/dashboard/widgets/summary_metrics_card.dart';

class CashFlowReportDashboard extends StatefulWidget {
  const CashFlowReportDashboard({super.key});

  @override
  State<CashFlowReportDashboard> createState() =>
      _CashFlowReportDashboardState();
}

class _CashFlowReportDashboardState extends State<CashFlowReportDashboard> {
  ...
  // Filter states
  String _cashFlowTimeFilter = 'month';
          ...
          SliverAppBar(
            ...
            title: Column(
              ...
              children: [
                ...
                Text(
                  'Real-time cashFlow insights and analytics',
                  style: Theme.of(
                    context,
  ...
  Widget _buildChartsSection() {
    if (isMobile) {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: RecentTransactionsTable(
              ...
              timeFilter: _cashFlowTimeFilter,
              onTimeFilterChanged: (value) {
                setState(() {
                  _cashFlowTimeFilter = value;
                });
              },
              transactions: _generateRecentCashFlow(),
              isCashFlow: true,
              tableHeight: 350,
            ),
          ),
          ...
          SizedBox(
            ...
            child: RecentTransactionsTable(
              ...
              transactions: _generateRecentCashFlows(),
              isCashFlow: false,
              tableHeight: 500,
            ),
          ),
      ...
      return Column(
        children: [
          // First Row: Average Time to Sell + Recent CashFlow
          Container(
          ...
          // Second Row: Inventory Value + Recent CashFlows
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
  ...
  Widget _buildRecentTransactionsSection() {
    final insightCards = [
      ...
      },
      {
        ...
        'description': 'Top 5 items by cashFlow velocity',
  ...
  List<TransactionData> _generateRecentCashFlow() {
    return [
      TransactionData(
        item: 'Laptop Pro M3',
  ...
  List<TransactionData> _generateRecentCashFlows() {
    return [
      TransactionData(
        item: 'Processor i9',

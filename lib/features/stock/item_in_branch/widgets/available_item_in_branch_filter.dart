...
class ItemInBranchAvailabilityFilterDialog extends StatefulWidget {
  final AvailableItemsInBranchFilter currentFilters;
  final Function(AvailableItemsInBranchFilter) onApply;
  final Function() onClear;

  const ItemInBranchAvailabilityFilterDialog({
    super.key,
  ...
  @override
  State<ItemInBranchAvailabilityFilterDialog> createState() =>
      _ItemInBranchAvailabilityFilterDialogState();
}

class _ItemInBranchAvailabilityFilterDialogState
    extends State<ItemInBranchAvailabilityFilterDialog> {
  late AvailableItemsInBranchFilter _filters;
  ...
  void _updateFilter(AvailableItemsInBranchFilter newFilters) {
    setState(() {
      _filters = newFilters;
    });
  }
